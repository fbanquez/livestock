...
class livestock_disease(models.Model):
    ...
    disease_date = fields.Datetime(string= 'Identifier Date', required=True, default=datetime.now(), help = 'Date at which the disease was identified')
    ...
    treatment = fields.Text(string='Treatment', required=False, help="Aplied Treatment")
...
class livestock_sanitary_protocol(models.Model):
    ...
    treatment_date = fields.Datetime(string= 'Treatment Date', required=True, default = datetime.now(), help = 'Date at which the treatment was applied')
